...
const CustomToolbar = () =>{
  ...
  const notify = () => toast.info('Saved Successfully....', { position: "bottom-center", autoClose: 3000, hideProgressBar: false, closeOnClick: true, pauseOnHover: false, draggable: true, progress: undefined,textStyle: {
    textAlign: 'center'
  }});

  const [obj, setObj] = useState({id:"",euip_name:"",euip_id:"",spec: "",department: "",dop: "",bill_date: "",cost: "",quip_status: "",unit_name: "",remarks: "",category: ""});
